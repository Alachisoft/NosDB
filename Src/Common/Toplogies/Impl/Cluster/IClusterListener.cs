...
namespace Alachisoft.NosDB.Common.Toplogies.Impl.Cluster
{
    ...
    {
        Object OnMessageReceived(Message message,ShardImpl.Server source);
        void OnShardAdd(ShardInfo shard);
        void OnShardRemove(ShardInfo shard, bool isGraceful);
        void OnDistributionChanged();
        void OnRangesUpdated();
        void OnNewRangeAdded();
    }
}
