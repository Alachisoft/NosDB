...
namespace Alachisoft.NosDB.Common.Logger
{
    ...
    public class InMemoryLogger
    {
        ...
        //public void Add(string key, BridgeOperation operation)
        //{
        //    lock (_hashtable.SyncRoot)
        //    {
        //        if (_hashtable.ContainsKey(key))
        //        {
        //            _hashtable[key] = operation;
        //            _updateCount++;
        //        }
        //        else
        //        {
        //            _hashtable.Add(key, operation);
        //            _addCount++;
        //        }
        //    }
        //}

        public static InMemoryLogger GetLogger(string srcCache, string LoggerType, ILogger nLog)
        {
            ...
            lock (_inMemoryLoggers)
            {
                ...
                else
                {
                    ...
                    logger.Initialize(srcCache, LoggerType, nLog);
        ...
        public void Initialize(string targetId, string LoggerType, ILogger nlogger)
        {
        ...
        private void Run()
        {
            while (_isThreadStopped)
            {
                ...
                _nlogger.Debug("InMemoryLogger",msg);                
            }
        }
