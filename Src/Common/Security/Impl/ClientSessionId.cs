...
{
    public class ClientSessionId : IClientSessionId , ICompactSerializable 
    {
        public string Username { set; get; }
        public string SessionId { set; get; }

        public ISessionId RouterSessionId { set; get; }
        ...
        public override int GetHashCode()
        {
            if (RouterSessionId != null)
                return SessionId.GetHashCode() ^ RouterSessionId.GetHashCode();
            else
        ...
        {
            bool isEqual = false;
            ClientSessionId clientSessionId = obj as ClientSessionId;
            if (clientSessionId != null)
            {
                isEqual = this.SessionId.Equals(clientSessionId.SessionId) && RouterSessionId.Equals(clientSessionId.RouterSessionId);
            }
            return isEqual;
        }
    }
