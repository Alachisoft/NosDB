...
{
    public interface IProxyPredicate : IOptimizable
    {
        List<ITreePredicate> TreePredicates { get; }

        TerminalPredicate GetExecutionPredicate(IQueryStore store);
        void AddChildPredicate(IProxyPredicate predicate);
    }
}
