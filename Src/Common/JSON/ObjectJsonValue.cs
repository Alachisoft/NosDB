...
{
    public class ObjectJsonValue : IJsonValue
    {
        private IJSONDocument _value;

        public ObjectJsonValue(IJSONDocument value)
        {
            _value = value;
        }
        ...
        {
            get { return FieldDataType.Object; }
        }
        ...
        {
            ObjectJsonValue secondJsonValue = obj as ObjectJsonValue;
