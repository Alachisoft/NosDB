...
{
    public class DateTimeConstantValue : ConstantValue, IEvaluable
    {
        ...
        {
            _dateString = lexeme;
            Constant = Convert.ToDateTime(lexeme.Trim(new[] { '\'' }));
        }

        public DateTimeConstantValue(DateTime dateTime)
        {
            Constant = dateTime;
        }
        ...
        {
            get { return "DateTime(" + _dateString + ")"; }
        }
        ...
        {
            output.Write("DateTimeConstant{"+Constant.ToString()+"}");
        }


        public string CaseSensitiveInString
        {
            get { return "DateTime(" + _dateString?? Constant.ToString() + ")"; }
        }
    }
}