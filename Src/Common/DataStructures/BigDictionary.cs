...
namespace Alachisoft.NosDB.Common.DataStructures
{
    public class BigDictionary : IDictionary
    {
        ...
        private class SyncBigDictionary : BigDictionary
        {
            ...
            //internal SyncBigDictionary(SerializationInfo info, StreamingContext context)
            //    : base(info, context)
            //{
            ...
            //    lock (this._bDic.SyncRoot)
            //    {
            //        return Hashtable.Synchronized((Hashtable)this._bDic.Clone());
            //    }
            //}
            ...
            //    }
            //    info.AddValue("ParentTable", this._bDic, typeof(Hashtable));
            //}
