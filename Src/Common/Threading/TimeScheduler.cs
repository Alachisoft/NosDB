...
namespace Alachisoft.NosDB.Common.Threading
{
	...
	public class TimeScheduler: IDisposable
	{
		...
		{
            /// <summary>
            /// If task is already running the should it run again if the timer hits.
            /// </summary>
		...
		private const String THREAD_NAME = "MainTimeScheduler.Thread";
        ...
        private static TimeScheduler _mainScheduler = new TimeScheduler();
        ...
        public static TimeScheduler Global
        {
            get { return _mainScheduler; }
        }
