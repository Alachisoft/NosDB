...
namespace RegUtil
{
	...
	static string		g_AppKeyName = _T("Software\\AlachiSoft\\NosDB");
	...
	// All keys are concatinated and returned back as a single string. [] Aug08'08
	//
 ...
 ***********************************/
	string GetRegBase(short prodId)
	{
		...
		if (prodId == 4)
		{
			g_AppKeyName = _T("Software\\AlachiSoft\\NosDB");
		}
