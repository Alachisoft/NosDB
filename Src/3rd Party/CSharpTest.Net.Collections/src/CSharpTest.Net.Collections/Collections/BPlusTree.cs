...
namespace CSharpTest.Net.Collections
{
    ...
    /// </summary>
    public partial class BPlusTree<TKey, TValue> : IDisposable, ITransactable, IEnumerable<KeyValuePair<TKey, IDictionary<TValue, byte>>> 
                                                    //,IDictionary<TKey, TValue>, IDictionaryEx<TKey, TValue>, IConcurrentDictionary<TKey, TValue>
    {
        ...
        public BPlusTree(BPlusTreeOptions<TKey, TValue> ioptions)
        {
            ...
            {
                _keyCount = nodeStoreWithCount.Count;
                _hasCount = _keyCount >= 0;
            }
        }
        ...
        void CommitChanges(bool requiresLock)
        {
            ...
            try
            {
                ...
                {
                    ((INodeStoreWithCount)_storage.Storage).Count = _hasCount ? _keyCount : -1;
                }
        ...
        public int Count { get { return _hasCount ? _keyCount : int.MinValue; } }

        /// <summary>
        /// Total Count of values in the tree, see comments on EnableCount(). 
        /// </summary>
        public int ValueCount { get { return _hasCount ? _valueCount : int.MinValue; } }
        ...
        /// </summary>
        public IDictionary<TValue, byte> this[TKey key]
        {
            get
            {
                IDictionary<TValue, byte> result = null;
        ...
        */
        ...
        /// <param name="key">The object to use as the key of the element to update.</param>
        /// <param name="value">The new value for the key if found.</param>
        /// <param name="oldValue">The value that is compared to the value of the element with key.</param>
        public bool TryUpdate(TKey key, TValue value, TValue oldValue)
        {
            UpdateIfValue ui = new UpdateIfValue(value, oldValue);
            bool result;
            using (RootLock root = LockRoot(LockType.Update, "Update"))
                result = Update(root.Pin, key, value, oldValue);
            DebugComplete("Updated({0}) = {1}", key, result);
            return ui.Updated;
        }
 ...
 * */
        ...
        /// </summary>
        public bool AddOrUpdate(TKey key, TValue createOrUpdateValue) //where T : ICreateOrUpdateValue<TKey, TValue>
        {
            InsertResult result = AddEntry(key, createOrUpdateValue);
        ...
        bool ICollection<KeyValuePair<TKey, TValue>>.Remove(KeyValuePair<TKey, TValue> item)
        {
            ...
            return RemoveEntry(item.Key, item.Value) == RemoveResult.Removed;
        }*/
        ...
        */
        ...
        {
            //RemoveAlways ri = new RemoveAlways();
            return RemoveEntry(key, null) == RemoveResult.Removed;
        }
         */
        ...
        */
        ...
        /// </summary>
        public bool TryRemove(TKey key, TValue removeValue) //where T : IRemoveValue<TKey, TValue>
        {
            return RemoveEntry(key, removeValue) == RemoveResult.Removed;
        }
        ...
        /// </summary>
        public KeyValuePair<TKey, IDictionary<TValue, byte>> First()
        {
            KeyValuePair<TKey, IDictionary<TValue, byte>> result;
        ...
        /// </summary>
        public KeyValuePair<TKey, IDictionary<TValue, byte>> Last()
        {
            KeyValuePair<TKey, IDictionary<TValue, byte>> result;
        ...
        /// Returns the last key and it's associated value.
        /// </summary>
        public bool TryGetLast(out KeyValuePair<TKey, IDictionary<TValue, byte>> item)
        {
        ...
        /// </summary>
        public IEnumerable<KeyValuePair<TKey, IDictionary<TValue, byte>>> EnumerateFrom(TKey start)
        {
        ...
        /// </summary>
        public IEnumerable<KeyValuePair<TKey, IDictionary<TValue, byte>>> EnumerateRange(TKey start, TKey end)
        {
            return new Enumerator(this, start, x => (_keyComparer.Compare(x, end) <= 0));
        }

        /// <summary>
        /// Returns an enumerator that iterates through the collection.
        /// </summary>
        public IEnumerator<KeyValuePair<TKey, IDictionary<TValue, byte>>> GetEnumerator()
        ...
        */
        ...
        {
            foreach (KeyValuePair<TKey, IDictionary<TValue, byte>> kv in this)
                foreach (var value in kv.Value)
                {
                    array[arrayIndex++] = new KeyValuePair<TKey, TValue>(kv.Key, value.Key);
                }
        }
