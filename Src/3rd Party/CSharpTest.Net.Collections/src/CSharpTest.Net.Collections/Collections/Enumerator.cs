...
namespace CSharpTest.Net.Collections
{
    ...
    {
        class Enumerator : IEnumerator<KeyValuePair<TKey, IDictionary<TValue, byte>>>, IEnumerable<KeyValuePair<TKey, IDictionary<TValue, byte>>>
        {
            ...
            readonly Predicate<TKey> _fnContinue;
            ...
            public Enumerator(BPlusTree<TKey, TValue> tree, TKey startKey, Predicate<TKey> fnContinue)
                : this(tree, startKey)
            {
            ...
            public KeyValuePair<TKey, IDictionary<TValue,byte>> Current
            {
                get
                {
                    return new KeyValuePair<TKey, IDictionary<TValue, byte>>(_currentSet[_currentOffset].Key,
                        _currentSet[_currentOffset].Payload);
                }
            }

            private TKey CurrentKey
            {
                get { return _currentSet[_currentOffset].Key; }
            }

            private IDictionary<TValue, byte> CurrentValue
            {
                get { return _currentSet[_currentOffset].Payload; }
            } 
