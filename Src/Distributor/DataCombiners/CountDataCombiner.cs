...
{
    class CountDataCombiner :IDataCombiner
    {
        ...
        public CountDataCombiner(IEnumerable<IEvaluable> attributes, string userDefinedName,bool aliasExists)
        {
        ...
        {
            if (!(initialValue is IJSONDocument)) throw new Exception("At CountDataCombiner: Document needs to be in IJSONDocument format");
        ...
        {
            if (!(value is IJSONDocument)) throw new Exception("At CountDataCombiner: Document needs to be in IJSONDocument format");
