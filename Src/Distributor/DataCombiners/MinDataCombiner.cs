...
{
    class MinDataCombiner : IDataCombiner
    {
        ...
        public MinDataCombiner(IEnumerable<IEvaluable> attributes, string userDefinedName, bool aliasExists)
        {
        ...
        {
            if (!(initialValue is IJSONDocument)) throw new Exception("At MinDataCombiner: Document needs to be in IJSONDocument format");
        ...
        {
            if (!(value is IJSONDocument)) throw new Exception("At MinDataCombiner: Document needs to be in IJSONDocument format");
