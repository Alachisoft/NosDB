...
namespace Alachisoft.NosDB.Core.Storage.Operations
{
    ...
    {
        private JSONDocument _update;

        public JSONDocument Update 
        {
            get { return _update; }
            set { _update = value; }
        }
