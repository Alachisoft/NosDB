...
namespace Alachisoft.NosDB.Core.Storage.Operations
{
    ...
    {
        private JSONDocument _replacement;

        public JSONDocument Replacement { get { return _replacement; } set { _replacement = value; } }
        
        public override OperationType OperationType
        {
            get { return Operations.OperationType.Replace; }
        }

        public override void Serialize(Common.Serialization.IO.CompactWriter writer)
        {
            base.Serialize(writer);
            writer.WriteObject(_replacement);
        }

        public override void Deserialize(Common.Serialization.IO.CompactReader reader)
        {
            base.Deserialize(reader);
            _replacement = (JSONDocument)reader.ReadObject();
        }
    }
}
