...
{
    class LocalDeleteResponse : LocalResponse, Alachisoft.NosDB.Common.Server.Engine.IDocumentsWriteResponse
    {
        ...
        public void AddFailedDocument(Common.Server.Engine.FailedDocument document)
        {
            if (document != null)
            {
