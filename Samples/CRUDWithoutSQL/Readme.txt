...
** The connection strings in the app.config file of samples have been changed according to the configurations made during import. For example, changes to the database name or configuration server port.
