...
{
    [Cmdlet(VerbsLifecycle.Start, "Shard")]
    public class StartShard:PSCmdlet
    {
        ...
        [Parameter(
            ...
            Position = 0,
            HelpMessage = "name of shard to be started.")]
        [Alias("n")]
        public string Name
        {
            get { return _shard; }
        ...
        {
            string exceptionString = "invalid Context, to Start-Shard you must be in \n NoSDB:\\databasecluster\\Shards \n ";
            ...
            if (s1.Drive.Current is NosDBPSDriveInfo)
            {
                ...
                if (thisNode.NodeType.Equals(PathType.Shards))
                {
                    ...
                    {
                        throw new Exception("Specify value for parameter Name or try to start shard from:\nNoSDB:\\databasecluster\\Shards\\shard. ");
                    }
                }
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                if (ConfigurationConnection.Current.StartShard(Name))
                {
                    //WriteObject("shard sucessfully started");
                }
            }
            catch
            {
